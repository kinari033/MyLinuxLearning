...
int getVideoBufForDisplay(PT_VideoBuf ptFrameBuf){
	ptFrameBuf->iPixelFormat = (g_ptDefaultDispOpr -> Bpp == 16) ? V4L2_PIX_FMT_RGB565 : \
								(g_ptDefaultDispOpr -> Bpp == 32) ? V4L2_PIX_FMT_RGB32 : 0;
	ptFrameBuf->iPixelFormat.iWidth  = 	g_ptDefaultDispOpr->iXres;	
	ptFrameBuf->iPixelFormat.iHeight = g_ptDefaultDispOpr->iYres;
	ptFrameBuf->iPixelFormat.Bpp = g_ptDefaultDispOpr->Bpp;
	ptFrameBuf->iPixelFormat.iLineBytes = g_ptDefaultDispOpr->iLineWidth;			
	ptFrameBuf->iPixelFormat.iTotalBytes = ptFrameBuf->iPixelFormat.iLineBytes * ptFrameBuf->iPixelFormat.iHeight;			
	ptFrameBuf->iPixelFormat.aucPixelDatas = g_ptDefaultDispOpr -> pucDispMem;
